...
<% request.setAttribute("title","删除产品"); %>
...
<div class="container" style="margin-top: 3.3%;margin-bottom: auto;">
    ...
    <div class="row">
        <div class="btn-group">
            <a class="btn btn-default" href="${pageContext.request.contextPath}/product/deleteSubmit/${model.productId}" class="btn btn-default">删除</a>
